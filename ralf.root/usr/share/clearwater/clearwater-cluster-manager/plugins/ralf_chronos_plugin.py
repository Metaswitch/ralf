...
class RalfChronosPlugin(SynchroniserPluginBase):
    ...
    def key(self):
        return "/ralf/clustering/chronos"
    ...
    def on_joining_cluster(self, cluster_view):
        _log.debug("This Ralf's Chronos is joining a Chronos cluster")
...
def load_as_plugin(local_server):
    return RalfChronosPlugin(local_server)
